...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "WebSocket", url: "https://github.com/vapor/websocket", .upToNextMajor(from: "1.1.2")),
        .package(name: "Starscream", url: "https://github.com/daltoniam/Starscream", .upToNextMajor(from: "4.0.4"))
    ],
    targets: [
